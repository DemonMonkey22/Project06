<?php
    require('midterm_solution/model/database.php');
    require('midterm_solution/model/vehicle_db.php');
    require('midterm_solution/model/type_db.php');
    require('midterm_solution/model/class_db.php');
    require('midterm_solution/model/make_db.php');
